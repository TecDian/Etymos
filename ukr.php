...
// Header
$loc_etymos_woerterbuch = 'Етимос словник - багатомовний і багатонаправлений';
...
$loc_keywords = 'мова, переклад, словник, граматика, згинання, схилення, сполучення, фонетика, вимова';

// Wörterbuchsprachen in spezifischer Reihenfolge
$dictlanguage = array('sqi', 'eng', 'ara', 'bel', 'bul', 'bos', 'ell', 'dan', 'est', 'gle', 'isl', 'spa', 'ita', 'cat', 'lav', 'lit', 'ltz', 'mkd', 'nld', 'deu', 'nor', 'pol', 'por', 'rus', 'ron', 'srp', 'slk', 'slv', 'tur', 'ukr', 'hun', 'fin', 'fra', 'hrv', 'ces', 'swe');
...
$language = array(
    ...
    'hye' => 'Вірменська',
    'lat' => 'Латинська',
    'pie' => 'Праіндоєвропейська',
    'pgm' => 'Прагерманська');

// Navigationsbox
$loc_portal = 'Портал';
$loc_suche = 'Пошук';
$loc_downloads = 'Завантаження';
$loc_fragen = 'Питання';
$loc_team = 'Команда';
