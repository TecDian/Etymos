...
$dictlanguage = array('sqi', 'eng', 'ara', 'bel', 'bul', 'bos', 'hun', 'ell', 'dan', 'gle', 'isl', 'spa', 'ita', 'cat', 'lav', 'lit', 'ltz', 'mkd', 'deu', 'nld', 'nor', 'pol', 'por', 'ron', 'rus', 'srp', 'slk', 'slv', 'tur', 'ukr', 'fin', 'fra', 'hrv', 'ces', 'swe', 'est');
...
$loc_portal = 'Портал';
$loc_suche = 'Искание';
$loc_downloads = 'Загрузки';
$loc_fragen = 'Вопросы';
$loc_team = 'Коллектив';

// Impressumseite
$loc_impressum = 'Выходные сведения';
$loc_gesetz = 'в соответствии с законом о телемедиа (TMG) и с законом о печати для штата Саксония-Анхальт (Landespressegesetz)';
$loc_webseite = 'Вебсайт';
$loc_eigentuemer = 'Владелец вебсайта: <span class="ori">Дипломированный физик Тек Диан дэ Акилет</span>';
$loc_autor = 'Ответственный автор: <span class="ori">Дипломированный физик Тек Диан дэ Акилет</span>';
$loc_kontakt = 'Контакт';
$loc_anschrift = 'Почтовый адрес: <span class="ori">Am Eichhornpark 1, 06217 Merseburg, Германия, Европейский Союз</span>';
$loc_telefon = 'Телефон';
$loc_telefax = 'Телефакс';
$loc_nachricht = 'Сообщение';
$loc_adresse = 'Электронный адрес';
$loc_absenden = 'Отправить';
$loc_loeschen = 'Удалять';

// Portalseite
$loc_titel = 'Этымос-Словарь';
...
$loc_collocation = 'Словосочетания';
$loc_definition = 'Определение';
$loc_inflection = 'Флексия';
$loc_origin = 'Происхождение';
$loc_family = 'Семья';
...
// $loc_mitwirkung_antwort1 = 'ANTWORT: <span class="markwhite">Unbedingt!</span> Hilfe in diesem Bereich ist sehr willkommen. Du solltest jedoch <span class="key">Primärsprachler</span> in der betreffenden Sprache sein oder zumindest über <span class="key">sehr gute Kenntnisse</span> verfügen. <span class="sourcelight">Bitte keine automatischen Übersetzungen!</span>';
