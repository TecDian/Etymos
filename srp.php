...
// Header
$loc_etymos_woerterbuch = 'Етимос речник - вишејезични и вишесмјерни';
...
$loc_keywords = 'језик, превод, речник, граматика, флексија, деклинација, коњугација, фонетика, изговор';

// Wörterbuchsprachen in spezifischer Reihenfolge
$dictlanguage = array('sqi', 'ara', 'bel', 'bos', 'bul', 'ell', 'dan', 'eng', 'est', 'gle', 'isl', 'ita', 'cat', 'lav', 'lit', 'ltz', 'hun', 'mkd', 'deu', 'nor', 'pol', 'por', 'ron', 'rus', 'slk', 'slv', 'srp', 'tur', 'ukr', 'fin', 'fra', 'nld', 'hrv', 'ces', 'swe', 'spa');
