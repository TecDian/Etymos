...
$loc_multilingual = 'çok dilli ve çok yönlü';
// $loc_description = '';
// $loc_keywords = '';

// Wörterbuchsprachen in spezifischer Reihenfolge
$dictlanguage = array('deu', 'ara', 'sqi', 'bel', 'bos', 'bul', 'ces', 'dan', 'est', 'nld', 'fin', 'fra', 'hrv', 'eng', 'gle', 'spa', 'swe', 'ita', 'isl', 'cat', 'pol', 'lav', 'lit', 'ltz', 'hun', 'mkd', 'nor', 'por', 'ron', 'rus', 'srp', 'slk', 'slv', 'tur', 'ukr', 'ell');
...
$tooltip['adj'] = 'sıfat, özelliklerini belirtmek için';
