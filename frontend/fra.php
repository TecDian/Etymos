...
$loc_multilingual = 'multilingue et multidirectionnel';
// $loc_description = '';
// $loc_keywords = '';

// Wörterbuchsprachen in spezifischer Reihenfolge
$dictlanguage = array('sqi', 'deu', 'eng', 'ara', 'bel', 'bos', 'bul', 'cat', 'hrv', 'dan', 'spa', 'est', 'fin', 'fra', 'ell', 'hun', 'gle', 'isl', 'ita', 'lav', 'lit', 'ltz', 'mkd', 'nld', 'nor', 'pol', 'por', 'ron', 'rus', 'srp', 'slk', 'slv', 'swe', 'ces', 'tur', 'ukr');
...
$tooltip['adj'] = 'adjectif, pour décrire des propriétés';
...
$loc_adresse = 'Adresse électronique';
// $loc_spamblock = '';
// $loc_spamtext = '';
// $loc_absenden = '';
// $loc_loeschen = '';
