...
$loc_multilingual = 'multilingv și multidirecțional';
// $loc_description = '';
// $loc_keywords = '';

// Wörterbuchsprachen in spezifischer Reihenfolge
$dictlanguage = array('sqi', 'ara', 'bel', 'bos', 'bul', 'cat', 'ces', 'hrv', 'dan', 'eng', 'est', 'fin', 'fra', 'deu', 'ell', 'gle', 'isl', 'ita', 'lav', 'lit', 'ltz', 'mkd', 'hun', 'nld', 'nor', 'pol', 'por', 'ron', 'rus', 'srp', 'slk', 'slv', 'spa', 'swe', 'tur', 'ukr');
...
$tooltip['adj'] = 'adjectiv, pentru a descrie proprietăți';
