...
$loc_multilingual = 'daudzvalodu un daudzvirzienu';
// $loc_description = '';
// $loc_keywords = '';

// Wörterbuchsprachen in spezifischer Reihenfolge
$dictlanguage = array('sqi', 'eng', 'ara', 'bel', 'bos', 'bul', 'ces', 'dan', 'fra', 'ell', 'hrv', 'est', 'gle', 'isl', 'ita', 'cat', 'rus', 'lav', 'lit', 'ltz', 'mkd', 'nld', 'nor', 'pol', 'por', 'ron', 'srp', 'slk', 'slv', 'fin', 'spa', 'tur', 'ukr', 'hun', 'deu', 'swe');
...
$tooltip['adj'] = 'adjektīvs, īpašības vārds';
