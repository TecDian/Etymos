...
$loc_description = 'Das Etymos-Wörterbuch liefert Übersetzungen zwischen 36 Sprachen in jeder beliebigen Richtung mit umfangreichen Informationen zu Semantik, Grammatik und Sononik.';
$loc_keywords = 'Sprache, Übersetzung, Wörterbuch, Grammatik, Flexion, Deklination, Konjugation, Sononik, Phonetik, Aussprache';
...
$tooltip = array(
    ...
    14 => 'poetisch, lyrisch',
    15 => 'raritativ, selten, ungebräuchlich',
    ...
    41 => 'inquestiv, fragend',
    42 => 'insultiv, beleidigend',
    43 => 'ironisch, umkehrend',
    44 => 'meliorativ, aufwertend, lobend',
    45 => 'negativ, verneinend',
    46 => 'pejorativ, abwertend, verächtlich',
    47 => 'positiv, bejahend',
    48 => 'provokativ, hetzerisch',
    49 => 'sarkastisch, verhöhnend, verspottend',
    50 => 'surpressiv, überrascht',
    51 => 'zynisch, verletzend, missachtend',
    64 => 'Wissenschaft',
    ...
    83 => 'Mosonik, Ethnologie, Kulturwissenschaft',
    ...
    194 => 'Architektur (Kunst), Baukunst, Landgestaltung',
    195 => 'Objektdesign, Gebrauchsgegenstandgestaltung',
    196 => 'Kunsthandwerk',
    197 => 'Gastronomie, Kulinarik, Esskultur',
    ...
    'abbr' => 'Abbreviation, Kürzelabkürzung',
    ...
    'spn' => 'Substantiv: Proprialnomen als Pluraletantum, Eigenname als Mehrzahlwort',
    ...
    'vus' => 'uniteratives Verb, mit indirektem Objekt identisch zum Subjekt und zwingender Anfügung eines stativen Objekts',
...
$loc_info_5 = 'systematische Erweiterung der Informationen zu <span class="level7">Semantik, Grammatik und Sononik</span>';
...
$loc_sono_deu1 = 'Grundlage der <span class="name">deutschen Aussprachebeschreibung</span> ist die in Deutschland gesprochene <span class="state">mitteldeutsche Standardform</span> der Umgangssprache. ';
$loc_sono_deu2 = 'Deutsche <span class="name">r-Laute</span> werden als <span class="sono">[ʀ]</span> und <span class="name">teilrhotiziert</span> angegeben. ';
$loc_sono_deu3 = '<span class="name">Kurzvokal</span> + <span class="source">r</span> wird alternativ als <span class="state">Dunkelvokal</span> + <span class="sono">[ʕ]</span> und als <span class="state">Klarvokal</span> + <span class="sono">[ʀ]</span> angegeben.';
$loc_sono_eng1 = 'Grundlage der <span class="name">englischen Aussprachebeschreibung</span> ist die in Großbritannien gesprochene <span class="state">Received Pronunciation</span> der Umgangssprache. ';
$loc_sono_eng2 = 'Englische <span class="name">r-Laute</span> werden als <span class="sono">[ɾ]</span> und <span class="name">nichtrhotiziert</span> angegeben.';
$loc_sono_spa1 = 'Grundlage der <span class="name">spanischen Aussprachebeschreibung</span> ist die in Spanien gesprochene <span class="state">kastilische Standardform</span> der Umgangssprache. ';
$loc_sono_spa2 = 'Dies betrifft vor allem die Paare <span class="source">b</span> und <span class="source">v</span>, <span class="source">c</span> und <span class="source">z</span>, <span class="source">j</span> und <span class="source">ll</span> ';
$loc_sono_spa3 = 'sowie <span class="source">d</span>, <span class="source">g</span> und <span class="source">x</span>.';
$loc_vokale = 'Vokale';
$loc_zeichen_wichtig1 = 'Im Vergleich zum <span class="level1">IPA</span> werden die <span class="name">Zeichen</span> ';
$loc_zeichen_wichtig2 = ' <span class="level3">anders</span> <span class="state">verwendet</span>, ';
$loc_zeichen_wichtig3 = ' <span class="level3">anders</span> <span class="state">interpretiert</span>.';
$loc_zeichen_wichtig4 = 'Alle <span class="level3">nicht</span> hier aufgelisteten <span class="name">Zeichen</span> des <span class="level1">IPA</span> sind ohne Relevanz und <span class="state">entfallen</span>.';
$loc_zeichen_wichtig5 = 'Im Gegensatz zur <span class="level1">IPA-Praxis</span> wird <span class="sono">ʔ</span> vor Vokalen <span class="state">auch im Wortanlaut</span> grundsätzlich immer angegeben, ';
$loc_zeichen_wichtig6 = 'wenn es dem <span class="name">Sprachstandard</span> entspricht.';
...
$loc_uvularisiert = 'uvularisiert';
$loc_separatoren = 'Separatoren';
$loc_traeger = 'Träger';
$loc_silbe = 'Silbe';
$loc_wort = 'Wort';
...
$loc_getrennt = 'getrennt';
$loc_innersilbisch = 'innersilbisch';
$loc_tonale = 'Tonale';
$loc_tonal = 'tonal';
...
$loc_level_explain[3] = 'Stichwort und Übersetzung mit vollständiger Typisierung, Stichwort mit Flexion und Sononik; verifiziert.';
$loc_level_name[4] = 'Aufbaueintrag 4';
$loc_level_explain[4] = 'Stichwort und Übersetzung mit vollständiger Typisierung, Stichwort mit Flexion, Sononik und Audio; verifiziert.';
$loc_level_name[5] = 'Aufbaueintrag 5';
$loc_level_explain[5] = 'Stichwort und Übersetzung mit vollständiger Typisierung, Stichwort mit Flexion, Sononik, Audio und Definition; verifiziert.';
$loc_level_name[6] = 'Aufbaueintrag 6';
$loc_level_explain[6] = 'Stichwort und Übersetzung mit vollständiger Typisierung, Stichwort mit Flexion, Sononik, Audio, Definition und Etymologie; verifiziert.';
$loc_level_name[7] = 'Volleintrag';
$loc_level_explain[7] = 'Stichwort und Übersetzung mit vollständiger Typisierung, Stichwort mit Flexion, Sononik, Audio, Definition, Etymologie und Kollokation; verifiziert.';
...
$loc_treiber_name2 = 'Sononisch/Phonetisch';
...
$loc_apps_installation1 = 'Inhalt des Archivs in ein beliebiges Verzeichnis auf dem Smartphone entpacken.';
...
$loc_projekt_antwort4.= '<span class="name">Grammatik</span> und <span class="sono">Sononik</span> zu ergänzen. Es gibt acht <span class="key">Bearbeitungsstufen</span>, die durch unterschiedliche Symbole gekennzeichnet werden.';
