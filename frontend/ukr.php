...
$loc_description = 'Словник Этимос пропонує переклад між 36 мовами в будь-якому напрямку з великою інформацією про семантику, граматику та сононіку.';
$loc_keywords = 'мова, переклад, словник, граматика, згинання, схилення, сполучення, сононика, фонетика, вимова';
...
$loc_verwendungsbereich = 'Область застосування';
$loc_stilebene = 'Рівень стилю';
$loc_fachgebiet = 'Сфера знань';
$loc_region = 'Регіон';
$loc_sprache = 'Мова';
...
$tooltip['s'] = 'іменник, для опису предметів';
