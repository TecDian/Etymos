...
$loc_description = 'Речник Етимос нуди превод између 36 језика у било ком правцу са опсежним информацијама о семантици, граматици и сононици.';
$loc_keywords = 'језик, превод, речник, граматика, флексија, деклинација, коњугација, сононика, фонетика, изговор';
...
$loc_verwendungsbereich = 'Област употребе';
$loc_stilebene = 'Стилски ниво';
$loc_fachgebiet = 'Област стручности';
$loc_region = 'Регион';
$loc_sprache = 'Језік';
...
$tooltip['s'] = 'именица, за описивање предмета';
