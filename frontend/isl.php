...
$loc_multilingual = 'fjöltyngdur og fjölstefnur';
// $loc_description = '';
// $loc_keywords = '';

// Wörterbuchsprachen in spezifischer Reihenfolge
$dictlanguage = array('sqi', 'ara', 'bos', 'bul', 'dan', 'est', 'eng', 'fin', 'fra', 'ell', 'nld', 'bel', 'gle', 'isl', 'ita', 'cat', 'hrv', 'lav', 'lit', 'ltz', 'mkd', 'nor', 'pol', 'por', 'ron', 'rus', 'srp', 'slk', 'slv', 'spa', 'swe', 'ces', 'tur', 'ukr', 'hun', 'deu');
...
$tooltip['adj'] = 'lýsingarorð, til að lýsa eiginleikum';
