...
// $loc_description = '';
$loc_keywords = 'tungumál, þýðing, orðabók, málfræði, beyging, fallbeyging, sagnbeyging, hljóðfræði, framburður';
...
$loc_verwendungsbereich = 'Notkunarsvæði';
$loc_stilebene = 'Stílstig';
$loc_fachgebiet = 'Sérfræðisvið';
$loc_region = 'Hérað';
$loc_sprache = 'Mál';
...
$tooltip['s'] = 'nafnorð, að lýsa hlutum';
$tooltip['v'] = 'sagnorð, að lýsa aðgerð';
