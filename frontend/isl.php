...
// $loc_autor = '';
// $loc_kontakt = '';
$loc_anschrift = 'Póstáritun';
$loc_deutschland = 'Þýskaland';
$loc_eu = 'Evrópusambandið';
// $loc_telefon = '';
// $loc_telefax = '';
// $loc_nachricht = '';
// $loc_adresse = '';
