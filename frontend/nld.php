...
$loc_multilingual = 'multilingueel en multidirectioneel';
// $loc_description = '';
// $loc_keywords = '';

// Wörterbuchsprachen in spezifischer Reihenfolge
$dictlanguage = array('sqi', 'ara', 'bel', 'bos', 'bul', 'cat', 'dan', 'deu', 'eng', 'est', 'fin', 'fra', 'ell', 'hun', 'gle', 'isl', 'ita', 'hrv', 'lav', 'lit', 'ltz', 'mkd', 'nld', 'nor', 'ukr', 'pol', 'por', 'ron', 'rus', 'srp', 'slv', 'slk', 'spa', 'ces', 'tur', 'swe');
...
$tooltip['adj'] = 'adjectief, bijvoeglijk naamwoord';
...
$loc_nachricht = 'Bericht';
$loc_adresse = 'E-mailadres';
// $loc_spamblock = '';
// $loc_spamtext = '';
// $loc_absenden = '';
// $loc_loeschen = '';
