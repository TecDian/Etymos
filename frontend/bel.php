...
$loc_multilingual = 'шматмоўны і рознанакіраваны';
// $loc_description = '';
// $loc_keywords = '';
...
$language = array(
    ...
    'pfi' => 'Прафінская',
    'gmh' => 'Сярэдневерхненямецкая ',
    'ota' => 'Асманская',
    'ofs' => 'Старажытнафрызская',
    'osx' => 'Старажытнасаксонская',
    'got' => 'Гоцкая',
    'cym' => 'Валійская',
    'fry' => 'Фрызская',
);
...
$tooltip[12] = 'устарэлы, састарэлы';
// $tooltip[13] = 'obszön, unanständig';
// $tooltip[14] = 'poetisch, lyrisch';
$tooltip[15] = 'малаўжывальны, рэдкі';
...
$tooltip['adj'] = 'прыметнік, для апісання ўласцівасцей';
...
$loc_telefon = 'Тэлефон';
$loc_nachricht = 'Паведамленне';
$loc_adresse = 'Адрас электроннай пошты';
// $loc_spamblock = '';
// $loc_spamtext = '';
// $loc_absenden = '';
// $loc_loeschen = '';
