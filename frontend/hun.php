...
$loc_multilingual = 'többnyelvű és többirányú';
// $loc_description = '';
// $loc_keywords = '';

// Wörterbuchsprachen in spezifischer Reihenfolge
$dictlanguage = array('sqi', 'eng', 'ara', 'bel', 'bul', 'bos', 'ces', 'dan', 'est', 'fin', 'fra', 'ell', 'nld', 'hrv', 'gle', 'isl', 'cat', 'pol', 'lav', 'lit', 'ltz', 'mkd', 'hun', 'deu', 'nor', 'ita', 'rus', 'por', 'ron', 'spa', 'swe', 'srp', 'slk', 'slv', 'tur', 'ukr');
...
$tooltip['adj'] = 'melléknév, tulajdonságok leírására';
