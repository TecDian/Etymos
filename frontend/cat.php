...
$loc_multilingual = 'multilingüe i multidireccional';
// $loc_description = '';
// $loc_keywords = '';

// Wörterbuchsprachen in spezifischer Reihenfolge
$dictlanguage = array('sqi', 'deu', 'eng', 'ara', 'bel', 'bos', 'bul', 'cat', 'hrv', 'dan', 'slk', 'slv', 'spa', 'est', 'fin', 'fra', 'ell', 'hun', 'gle', 'isl', 'ita', 'lav', 'lit', 'ltz', 'mkd', 'nld', 'nor', 'pol', 'por', 'ron', 'rus', 'srp', 'swe', 'tur', 'ces', 'ukr');
...
$tooltip['adj'] = 'adjectiu, per descriure propietats';
