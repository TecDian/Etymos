...
// $loc_description = '';
$loc_keywords = 'اللغة، الترجمة، القاموس، القواعد، التصريف، الإنحراف، الصوتيات، النطق';
...
$loc_verwendungsbereich = 'مجال الاستخدام';
$loc_stilebene = 'مستوى الاسلوب';
$loc_fachgebiet = 'مجال الخبرة';
$loc_region = 'منطقة';
$loc_sprache = 'لغة';
