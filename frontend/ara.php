...
$loc_multilingual = 'متعدد اللغات ومتعدد الاتجاهات';
// $loc_description = '';
// $loc_keywords = '';

// Wörterbuchsprachen in spezifischer Reihenfolge
$dictlanguage = array('spa', 'est', 'sqi', 'deu', 'eng', 'ukr', 'gle', 'isl', 'ita', 'por', 'bul', 'bos', 'pol', 'bel', 'tur', 'ces', 'dan', 'rus', 'ron', 'slk', 'slv', 'swe', 'srp', 'ara', 'fra', 'fin', 'cat', 'hrv', 'lav', 'ltz', 'lit', 'hun', 'mkd', 'nor', 'nld', 'ell');
...
$language = array(
    ...
    'lat' => 'لاتينية',
    'pie' => 'هندوأوروبية بدائية',
    'pgm' => 'جرمانية بدائية',
    'akk' => 'أكدية',
    'grc' => 'إغريقية',
    'pfi' => 'فنلندية بدائية',
    'gmh' => 'ألمانية عليا وسطى',
    'ota' => 'عثمانية',
    'ofs' => 'فريزية قديمة',
    'osx' => 'سكسونية قديمة',
    'got' => 'قوطية',
...
$loc_telefon = 'هاتف';
$loc_nachricht = 'رِسَالَةٌ';
$loc_adresse = 'عنوان بريد إلكتروني';
// $loc_spamblock = '';
// $loc_spamtext = '';
// $loc_absenden = '';
// $loc_loeschen = '';
