...
$loc_multilingual = 'πολύγλωσσο και πολυκατευθυντικό';
// $loc_description = '';
// $loc_keywords = '';

// Wörterbuchsprachen in spezifischer Reihenfolge
$dictlanguage = array('eng', 'sqi', 'ara', 'bos', 'bul', 'fra', 'deu', 'dan', 'ell', 'est', 'gle', 'isl', 'spa', 'ita', 'cat', 'hrv', 'lav', 'bel', 'lit', 'ltz', 'mkd', 'nor', 'nld', 'hun', 'ukr', 'pol', 'por', 'ron', 'rus', 'srp', 'slk', 'slv', 'swe', 'tur', 'ces', 'fin');
...
$language = array(
    ...
    'vie' => 'Βιετναμικά',
    'zho' => 'Κινεζικά',
    'goh' => 'Παλαιά υψηλά γερμανικά',
    'lat' => 'Λατινικά',
    'pie' => 'Πρωτοϊνδοευρωπαϊκά',
    'pgm' => 'Πρωτογερμανικά',
    'akk' => 'Ακκαδικά',
    'grc' => 'Αρχαία ελληνικά',
    'pfi' => 'Πρωτοφινλανδικά',
    'gmh' => 'Μέσα υψηλά γερμανικά',
    'ota' => 'Οθωμανικά',
    'ofs' => 'Αρχαία φριζικά',
    'osx' => 'Αρχαία σαξονικά',
    'got' => 'Gotiskά',
...
$tooltip['adj'] = 'επίθετο, για να περιγράψω ιδιότητες';
