...
// $loc_description = '';
$loc_keywords = 'γλώσσα, μετάφραση, λεξικό, γραμματική, κλίση, σονονική, φωνητική, προφορά';
...
$loc_verwendungsbereich = 'Περιοχή χρήσης';
$loc_stilebene = 'Επίπεδο στυλ';
$loc_fachgebiet = 'Ειδικός τομέας';
$loc_region = 'Περιοχή';
$loc_sprache = 'Γλώσσα';
