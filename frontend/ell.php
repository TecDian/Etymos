<?php
// -------------------------------------------------------------------------------------------------
// Seiteninhalt Griechisch
// -------------------------------------------------------------------------------------------------

// Header
$loc_etymos_woerterbuch = 'Ετυμοσ-Λεξικό - πολύγλωσσο και πολυκατευθυντικό';
// $loc_description = '';
// $loc_keywords = '';
...
$language['deu'] = 'Γερμανικά';
$language['ell'] = 'Ελληνικά';
...
$tooltip[292] = 'Αλβανία';
$tooltip[293] = 'Κοσσυφοπέδιο';
$tooltip[320] = 'Γερμανία';
...
// $loc_autor = '';
// $loc_kontakt = '';
$loc_anschrift = 'Ταχυδρομική διεύθυνση';
$loc_deutschland = 'Γερμανία';
$loc_eu = 'Ευρωπαϊκή Ένωση';
// $loc_telefon = '';
// $loc_telefax = '';
// $loc_nachricht = '';
$loc_adresse = 'Διεύθυνση ηλεκτρονικού ταχυδρομείου';
// $loc_spamblock = '';
// $loc_spamtext = '';
// $loc_absenden = '';
// $loc_loeschen = '';
