...
$language['gmh'] = 'Μέση υψηλή γερμανική';
$language['ota'] = 'Οθωμανικά';
$language['ofs'] = 'Αρχαία φριζικά';
$language['osx'] = 'Αρχαία σαξονικά';
$language['got'] = 'Gotiskά';
$language['cym'] = 'Ουαλικά';
