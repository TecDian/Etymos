...
// $loc_description = '';
$loc_keywords = 'язык, перевод, словарь, грамматика, флексия, склонение, спряжение, сононика, фонетика, произношение';
...
$loc_verwendungsbereich = 'Область использования';
$loc_stilebene = 'Уровень стиля';
$loc_fachgebiet = 'Область знаний';
$loc_region = 'Регион';
$loc_sprache = 'Язык';
