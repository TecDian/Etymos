...
$loc_multilingual = 'wielojęzyczny i wielokierunkowy';
// $loc_description = '';
// $loc_keywords = '';

// Wörterbuchsprachen in spezifischer Reihenfolge
$dictlanguage = array('sqi', 'eng', 'ara', 'bel', 'bos', 'bul', 'hrv', 'ces', 'dan', 'est', 'fin', 'fra', 'ell', 'spa', 'gle', 'isl', 'cat', 'lit', 'ltz', 'lav', 'mkd', 'nld', 'deu', 'nor', 'pol', 'por', 'rus', 'ron', 'srp', 'slk', 'slv', 'swe', 'tur', 'ukr', 'hun', 'ita');
...
$tooltip['adj'] = 'przymiotnik, aby opisać właściwości';
...
$loc_telefon = 'Telefon';
$loc_nachricht = 'Komunikat';
$loc_adresse = 'Adres e-mailowy';
// $loc_spamblock = '';
// $loc_spamtext = '';
// $loc_absenden = '';
// $loc_loeschen = '';
