...
$loc_mitwirkung_antwort1 = 'ANSWER: <span class="markwhite">Definitely!</span> Assistence in this area is very welcome. However, the language concerned should be your <span class="key">primary language</span> or at least you should have <span class="key">very good knowledge</span> of it. <span class="sourcelight">Please no automatic translations!</span> You can find the current state of the translation at <a href="https://github.com/TecDian/Etymos" target="_blank">GitHub</a>. German is the main reference, English is second with lower priority.';
