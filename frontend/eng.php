...
$loc_description = 'The Etymos-Dictionary offers translation between 36 languages in any direction with extensive information on semantics, grammar and sononics.';
$loc_keywords = 'language, translation, dictionary, grammar, inflection, declension, conjugation, sononics, phonetics, pronunciation';
...
$loc_info_5 = 'systematic expansion of the information on <span class="level7">semantics, grammar and sononics</span>';
...
$loc_lautliche_umschrift1 = 'For <span class="state">sound transcription</span> the <span class="sourcelight">sonic notation</span> is used. ';
...
$loc_sono_deu1 = 'The basis of the description of the <span class="name">German pronunciation</span> is the <span class="state">Central German standard form</span> of the colloquial language spoken in Germany. ';
$loc_sono_deu2 = 'German <span class="name">r-sounds</span> are specified as <span class="sono">[ʀ]</span> and <span class="name">partially rhoticised</span>. ';
$loc_sono_deu3 = '<span class="name">Short vowel</span> + <span class="source">r</span> is specified alternatively as <span class="state">dark vowel</span> + <span class="sono">[ʕ]</span> and as <span class="state">clear vowel</span> + <span class="sono">[ʀ]</span>.';
$loc_sono_eng1 = 'The basis of the description of the <span class="name">English pronunciation</span> is the <span class="state">Received Pronunciation</span> of the colloquial language spoken in Great Britain. ';
$loc_sono_eng2 = 'English <span class="name">r-sounds</span> are specified as <span class="sono">[ɾ]</span> and <span class="name">unrhoticised</span>.';
$loc_sono_spa1 = 'The basis of the description of the <span class="name">Spanish pronunciation</span> is the <span class="state">Castilian standard form</span> of the colloquial language spoken in Spain. ';
$loc_sono_spa2 = 'This mainly affects the pairs <span class="source">b</span> and <span class="source">v</span>, <span class="source">c</span> and <span class="source">z</span>, <span class="source">j</span> and <span class="source">ll</span> ';
$loc_sono_spa3 = 'as well as <span class="source">d</span>, <span class="source">g</span> and <span class="source">x</span>.';
$loc_vokale = 'Vowels';
$loc_zeichen_wichtig1 = 'In comparison to <span class="level1">IPA</span> the <span class="name">signs</span> ';
$loc_zeichen_wichtig2 = ' are <span class="state">used</span> <span class="level3">differently</span>, ';
$loc_zeichen_wichtig3 = ' are <span class="state">interpreted</span> <span class="level3">differently</span>.';
$loc_zeichen_wichtig4 = 'All <span class="name">signs</span> of <span class="level1">IPA</span> <span class="level3">not</span> listed here hold no relevance and are <span class="state">omitted</span>.';
$loc_zeichen_wichtig5 = 'In contrast to the <span class="level1">IPA practice</span>, <span class="sono">ʔ</span> is always written before vowels, <span class="state">even in the initial sound of a word</span >, ';
$loc_zeichen_wichtig6 = 'if it corresponds to the <span class="name">language standard</span>.';
...
$loc_uvularisiert = 'uvularised';
$loc_separatoren = 'Separators';
$loc_traeger = 'Carrier';
$loc_silbe = 'syllable';
$loc_wort = 'word';
...
$loc_getrennt = 'separat';
$loc_innersilbisch = 'intrasyllabic';
$loc_tonale = 'Tonals';
$loc_tonal = 'tonal';
...
$loc_level_explain[3] = 'lemma and translation with complete characterisation; lemma with inflection and sononics; verified.';
$loc_level_name[4] = 'Revision entry 4';
$loc_level_explain[4] = 'lemma and translation with complete characterisation; lemma with inflection, sononics and audio; verified.';
$loc_level_name[5] = 'Revision entry 5';
$loc_level_explain[5] = 'lemma and translation with complete characterisation; lemma with inflection, sononics, audio and definition; verified.';
$loc_level_name[6] = 'Revision entry 6';
$loc_level_explain[6] = 'lemma and translation with complete characterisation; lemma with inflection, sononics, audio, definition and etymology; verified.';
$loc_level_name[7] = 'Full entry';
$loc_level_explain[7] = 'lemma and translation with complete characterisation; lemma with inflection, sononics, audio, definition, etymology and  collocation; verified.';
...
$loc_projekt_antwort4.= '<span class="name">grammar</span> and <span class="sono">sononics</span>. There are eight <span class="key">revision levels</span>, identified by different symbols.';
