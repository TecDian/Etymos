...
//     48 => 'sarkastisch, verhöhnend, verspottend',
    49 => 'cynical, hurting, disregarding',
    50 => 'inquestive, questioning',
    51 => 'surpressive, surprised',
    64 => 'science',
...
//     481 => 'Latinika',
    ...
    'abbr' => 'abbreviation, letter word',
    'acro' => 'acronym, initial word or syllable word',
    ...
    'def' => 'definite, to mark a special one',
    'dem' => 'demonstative, to mark one in contrast to others',
    'det' => 'determinative, to mark a special group',
    'ind' => 'indefinite, to not mark a special one',
    'int' => 'interrogative, to mark a question',
    'per' => 'personal, to mark the speaker, listener or object',
    'pos' => 'possessive, to mark an affiliation',
    'rec' => 'reciprocal, to relate between two or more',
    'ref' => 'reflexive, to relate back to someone or something',
    'rel' => 'relative, to relatw to someone or something',
    ...
    'ssp' => 'noun: proprial noun as plural tantum, proper noun as plural word',
    'm' => 'masculine, male',
    'f' => 'feminine, female',
    'n' => 'neuter, neutral',
    'a' => 'animate, alive',
    ...
    'vrp' => 'reflexive verb, with direct object identical to the subject and compulsory extention by a prepositive object',
    ...
    'univ' => 'universal, to specify a subject or object (one)',
    ...
    'hon' => 'honorative, honored listener or listeners',
    'hon.sg' => 'honorative singular, single honored listener',
    'hon.pl' => 'honorative plural, several honored listeners',
...
$loc_news = '26 February 2021</span> <span class="code">neu:</span> Entries were revised, phonetics and definitions were added. Structures for phrases and non-translatable words were added. Estonian was considerably extended.';
// Sprachwahlfenster
