...
$loc_multilingual = 'multilíngue e multidirecional';
// $loc_description = '';
// $loc_keywords = '';

// Wörterbuchsprachen in spezifischer Reihenfolge
$dictlanguage = array('sqi', 'deu', 'ara', 'bel', 'bos', 'bul', 'cat', 'hrv', 'dan', 'slk', 'slv', 'spa', 'est', 'fin', 'fra', 'ell', 'hun', 'eng', 'gle', 'isl', 'ita', 'lav', 'lit', 'ltz', 'mkd', 'nld', 'nor', 'pol', 'por', 'ron', 'rus', 'srp', 'swe', 'ces', 'tur', 'ukr');
...
$tooltip['adj'] = 'adjetivo, para descrever propriedades';
