...
$loc_description = 'O Dicionário Etymos oferece tradução entre 36 idiomas em qualquer direção, com ampla informação sobre semântica, gramática e sonónica.';
$loc_keywords = 'idioma, tradução, dicionário, gramática, inflexão, declinação, conjugação, sonónica, fonética, pronúncia';
...
$loc_verwendungsbereich = 'Área de uso';
$loc_stilebene = 'Nível de estilo';
$loc_fachgebiet = 'Área de especialização';
$loc_region = 'Região';
$loc_sprache = 'Língua';
