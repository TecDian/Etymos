...
$loc_description = 'Etymos ordbok erbjuder översättning mellan 36 språk i alla riktningar med omfattande information om semantik, grammatik och sononik.';
$loc_keywords = 'språk, översättning, ordbok, grammatik, böjning, deklination, konjugation, sononik, fonetik, uttal';
...
$loc_verwendungsbereich = 'Användningsområde';
$loc_stilebene = 'Stilnivå';
$loc_fachgebiet = 'Expertområde';
$loc_region = 'Region';
$loc_sprache = 'Språk';
...
$tooltip['s'] = 'substantiv, namnord';
$tooltip['v'] = 'verb, händelseord';
