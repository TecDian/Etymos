...
$dictlanguage = array('sqi', 'deu', 'ara', 'bel', 'bos', 'bul', 'cat', 'ces', 'hrv', 'dan', 'slk', 'slv', 'spa', 'est', 'fin', 'fra', 'ell', 'hun', 'eng', 'gle', 'isl', 'ita', 'lav', 'lit', 'ltz', 'mkd', 'nld', 'nor', 'por', 'pol', 'ron', 'rus', 'srp', 'swe', 'tur', 'ukr');
...
$loc_portal = 'Portal';
$loc_suche = 'Búsqueda';
$loc_downloads = 'Descargas';
$loc_fragen = 'Preguntas';
$loc_team = 'Equipo';
