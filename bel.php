...
$dictlanguage = array('sqi', 'eng', 'ara', 'bul', 'bos', 'bel', 'hun', 'ell', 'dan', 'gle', 'isl', 'spa', 'ita', 'cat', 'lav', 'lit', 'ltz', 'mkd', 'nor', 'nld', 'deu', 'por', 'pol', 'ron', 'rus', 'srp', 'slk', 'slv', 'tur', 'ukr', 'fin', 'fra', 'hrv', 'ces', 'swe', 'est');
...
$language = array(
    ...
    'fas' => 'Персідская',
    'fry' => 'Фрызская',
    'goh' => 'Старажытнаверхненямецкая',
    'hye' => 'Армянская',
    'lat' => 'Лацінская',
    'pie' => 'Праіндаеўрапейская',
    'pgm' => 'Прагерманская'
);
